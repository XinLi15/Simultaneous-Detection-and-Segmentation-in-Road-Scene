...
def inference(hypes, images, train=True):
    ...
    if hypes['arch']['fcn_in'] == 'pool5':
        logits['fcn_in'] = vgg_fcn.conv4_3
    elif hypes['arch']['fcn_in'] == 'fc7':
        logits['fcn_in'] = vgg_fcn.fc7
    elif hypes['arch']['fcn_in'] == 'fc6':
        logits['fcn_in'] = vgg_fcn.fc6    
    else:
        raise NotImplementedError

    logits['feed2'] = vgg_fcn.pool4
    logits['feed4'] = vgg_fcn.conv4_3

    logits['fcn_logits'] = vgg_fcn.fuse

    logits['deep_feat'] = vgg_fcn.conv4_3
    logits['early_feat'] = vgg_fcn.conv2_2
