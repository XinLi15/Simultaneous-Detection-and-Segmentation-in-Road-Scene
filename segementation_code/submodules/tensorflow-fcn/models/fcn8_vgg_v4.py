...
class FCN8VGG:
    ...
    '''   
    def spatial_dropout(self,x,drop_prob):
    ...
    def build(self, rgb, train=False, num_classes=20, random_init_fc8=False,
		...
		#'''
        self.conv4_1 = self._conv_layer(self.pool3, "conv4_1",atrous_rate=4)
        self.conv4_2 = self._conv_layer(self.conv4_1, "conv4_2",atrous_rate=8)
        self.conv4_3 = self._conv_layer(self.conv4_2, "conv4_3",atrous_rate=16)
       ...
       # self.s_drop5_3 = self._spatial_dropout(self.conv5_3,0.05)
        ...
        if random_init_fc8:
            ...
            self.score_fr = self._fc_layer(self.fc7, "score_fr",
                                           ...
                                           relu=False)
        '''
        self.pred = self._score_layer(self.conv4_3,'score_bot', num_classes=num_classes)

#        self.upscore2 = self._upscore_layer(self.pool5,
 ...
 #                                           ksize=4, stride=2)
      #  self.score_pool4 = self._score_layer(self.pool4, "score_pool4",
       ...
       # self.fuse_pool4 = tf.add(self.upscore2, self.score_pool4)
        ...
        self.upscore3 = self._upscore_layer(self.pred,
        ...
        self.score_pool2 = self._score_layer(self.pool2, "score_pool2",
                                             ...
                                             num_classes=num_classes)
        self.fuse_pool2 = tf.add(self.upscore3, self.score_pool2)

        self.upscore8 = self._upscore_layer(self.fuse_pool2,
                                             shape=tf.shape(bgr),
                                             num_classes=num_classes,
