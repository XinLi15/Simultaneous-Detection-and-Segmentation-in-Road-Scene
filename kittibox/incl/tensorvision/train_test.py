...
def run_training(hypes, modules, tv_graph, tv_sess, start_step=0):
    ...
    print( os.path.join(hypes['dirs']['data_dir'],   hypes['data']['val_idl']))
    print( os.path.join(hypes['dirs']['data_dir'],   hypes['data']['train_idl']))
...
#             _, loss_total, loss_conf, loss_box = sess.run([tv_graph['train_op'],
#                                       tv_graph['losses']['total_loss'],
#                                        tv_graph['losses']['confidences_loss'],
#                                        tv_graph['losses']['boxes_loss']],
#                                        feed_dict=feed_dict)
#             print(loss_total)
#             print(loss_conf)
#             print(loss_box)
...
def do_training(hypes, logdir):
    ...
    with tf.Session() as sess:
        ...
        tv_sess = core.start_tv_session(hypes,logdir)
...
#####-------------------------------------DEBUGGING
    postfix = ""
    f =  '/home/ava/KittiBox/RUNS/KittiBox/KittiBox/KittiBox_pretrained/model_files/objective2.py'
