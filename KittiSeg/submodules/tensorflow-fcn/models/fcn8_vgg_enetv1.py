...
class FCN8VGG:
    ...
    def build(self, rgb, train=False, num_classes=20, random_init_fc8=False,
        ...
        self.conv1_1 = self._conv_layer(self.down_1, "conv1_1")
        self.conv1_2 = self._conv_layer(self.conv1_1, "conv1_2")
        #self.pool1 = self._max_pool(self.conv1_2, 'pool1', debug)

        self.conv2_1 = self._conv_layer(self.conv1_2, "conv2_1")
        self.conv2_2 = self._conv_layer(self.conv2_1, "conv2_2")
        self.pool2 = self._max_pool(self.conv2_2, 'pool2', debug)

        self.conv3_1 = self._conv_layer(self.pool2, "conv3_1")
        self.conv3_2 = self._conv_layer(self.conv3_1, "conv3_2",atrous_rate=2)
       ...
       # self.s_drop5_3 = self._spatial_dropout(self.conv5_3,0.05)
        ...
        if random_init_fc8:
            ...
            self.score_fr = self._fc_layer(self.fc7, "score_fr",
                                           ...
                                           relu=False)
        '''
        self.pred = tf.argmax(self.pool4, dimension=3)
 ...
 #                                           ksize=4, stride=2)
      #  self.score_pool4 = self._score_layer(self.pool4, "score_pool4",
       ...
       # self.fuse_pool4 = tf.add(self.upscore2, self.score_pool4)
        ...
        self.upscore4 = self._upscore_layer(self.pool4,
